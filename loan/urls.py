...
from .views import LoanListAPI, CreateLoanAPi, CreateLoanOfferAPi, AcceptLoanOfferAPi, SettlePaymentAPi, RejectLoanOfferAPi, OffersListAPI
...
urlpatterns = [
    ...
    path('api/list/<int:loan>/offers', OffersListAPI().as_view(), name='list_loans'),
